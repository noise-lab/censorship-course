...
**Prep reads (5–10 min).**
- *[Placeholder — refresh skill will populate with the original Meta announcement (Jan 2025) and any follow-up reporting on rollout, coverage rates, or accuracy of Community Notes vs. the prior fact-checking regime.]*
- *[Placeholder — recent empirical study of X's Community Notes effectiveness during a high-stakes event (election, war, health crisis), especially studies measuring latency to correction and downstream reach.]*
<!-- current-events:end -->
...
**Prep reads (5–10 min).**
- *[Placeholder — refresh skill will populate with recent US, EU, or state-level legislation or court rulings on algorithmic amplification liability — e.g., DSA enforcement actions, Section 230 reform proposals, or Gonzalez v. Google follow-ups.]*
- *[Placeholder — recent case study of an election- or health-related disinformation cascade that spread primarily through algorithmic recommendation rather than user sharing.]*
<!-- current-events:end -->
